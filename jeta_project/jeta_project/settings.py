"""
Django settings for jeta_project project.
...
SECRET_KEY = 'ezguhj3r4yn&dad^#2=c2*urms%a0so7s$d^d*-($s(cs6ry54'
...
ROOT_URLCONF = 'jeta_project.urls'
...
WSGI_APPLICATION = 'jeta_project.wsgi.application'
